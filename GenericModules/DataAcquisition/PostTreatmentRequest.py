...
#  Extracting and formate the data from raw data
@dataclass
class PostTreatmentQuery:

    list_features_to_extract: list[str] = None
    output_type_in_dict_df: bool = True

    def __post_init__(self):
        if self.list_features_to_extract is None:
    ...
    def extract_events__sort_it_by_observation(self, raw_data):
    ...
    def _select_relevant_data_from_details(details_data):
        ...
        # there is generally an only key in details data... to check
